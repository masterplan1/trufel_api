...
<section class="order" data-id="<?php echo $id;?>" data-type="<?php echo $productType;?>" data-name="<?php echo $productName;?>">
    <div class="order__wrapper">
        ...
        <div class="order__status">
            <div class="order__status-item first">
            ...
            <div class="order__status-item third third-active">
...
<!--            <div class="order__content-cards-first">
                ...
                <span class="order__content-card order-candybar order-item" data-id1=3>
                    Candy bar
                </span>
            </div>  -->
...
<!--            <div class="order__content-cards-2 inactive-status">
            ...
            <div class="order__content-cards-2">
