...
//    validateStep(5, 'asd');
        ...
        productId = $('.order').data('id');
//        console.log(productId);
        let typeId = $('.order').data('type');
        categoryId = productType[typeId]
        let productOrderName = $('.order').data('name');
        
//        $('.products__card-order').css('visibility', 'hidden'); //min-weight hide
...
//            }
            orderDecoration.html(productOrderName);
